...
package moodle.sync.core.model.shape;

import moodle.sync.core.geometry.Dimension2D;
import moodle.sync.core.geometry.GeometryUtils;
...
import moodle.sync.core.graphics.StrokeLineCap;
import moodle.sync.core.input.KeyEvent;
import moodle.sync.core.model.shape.PenShape;
import moodle.sync.core.tool.Stroke;
