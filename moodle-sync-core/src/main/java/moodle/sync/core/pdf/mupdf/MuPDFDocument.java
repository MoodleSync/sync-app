...
package moodle.sync.core.pdf.mupdf;

import com.artifex.mupdf.fitz.*;
import moodle.sync.core.geometry.Rectangle2D;
import moodle.sync.core.io.BitConverter;
import moodle.sync.core.model.DocumentOutline;
import moodle.sync.core.model.DocumentOutlineItem;
import moodle.sync.core.model.shape.Shape;
import moodle.sync.core.pdf.DocumentAdapter;
import moodle.sync.core.pdf.DocumentRenderer;
import moodle.sync.core.pdf.PdfDocument;
import moodle.sync.core.pdf.mupdf.MuPDFRenderer;
import moodle.sync.core.pdf.mupdf.SimpleTextWalker;
import moodle.sync.core.pdf.mupdf.WordWalker;
